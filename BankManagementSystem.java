...
class BankAdmin {
    ...
    public void viewCustomerProfile(BankCustomer customer) {
        System.out.println("Customer Profile - Name: " + customer.name +
                ", Account Number: " + customer.accountNumber + ", Balance: " + customer.balance);
    }

    // View employee profile
    public void viewEmployeeProfile(BankEmployee employee) {
        System.out.println("Employee Profile - Name: " + employee.name +
                ", Employee ID: " + employee.employeeId + ", Position: " + employee.position);
    }
}
...
public class BankManagementSystem {
    public static void main(String[] args) {
        ...
        BankCustomer customer = new BankCustomer(customerName, accountNumber, initialBalance);
        ...
        BankEmployee employee = new BankEmployee(employeeId, employeeName, employeePosition);
